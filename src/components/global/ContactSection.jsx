                    ...
                    <div className="flex flex-col justify-start space-y-[clamp(2rem,5vw,3rem)]">
                        ...
                        <div className="space-y-[clamp(1rem,2vw,1.5rem)]">
                            ...
                            <div className="flex flex-wrap gap-[1rem]">
                                ...
                                <a href="https://www.youtube.com/@nittygrittymedia" target="_blank" rel="noopener noreferrer" className="bg-white text-black w-[2.5rem] h-[2.5rem] rounded-full flex items-center justify-center hover:bg-neutral-200 transition-colors">
